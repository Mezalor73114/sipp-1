...
/* Set the path of the audio file pass in arguments to the defaut scenario audio_file */
char* set_audio_file(const char* buffer, char* path) {
...
scenario::scenario(char * filename, int deflt, char* path)
{
    char * elem;
    ...
    if(filename) {
        ...
        char* set_audio = set_audio_file(default_scenario[deflt], path);
        if(!xp_set_xml_buffer_from_string(set_audio)) {
...
const char * default_scenario [] = {
   ...
   "<?xml version=\"1.0\" encoding=\"ISO-8859-1\" ?>\n"
    ...
    "<!-- 59 Temple Place, Suite 330, Boston, MA  02111-1307 USA             -->\n"
    "<!--                                                                    -->\n"
    "<!--                 Sipp default 'audio_file' scenario.                       -->\n"
    "<!--                                                                    -->\n"
    "\n"
    "<scenario name=\"Basic Audio file UAC\">\n"
    "  <!-- In client mode (sipp placing calls), the Call-ID MUST be         -->\n"
    "  <!-- generated by sipp. To do so, use [call_id] keyword.                -->\n"
    "  <send retrans=\"500\">\n"
    "    <![CDATA[\n"
